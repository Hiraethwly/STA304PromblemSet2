...
Below is the boxplots between health and feelings of life (Graph 4 and Graph 5)

```{r, echo = FALSE, fig.height = 3, fig.width = 5, fig.align = "center", warnings=F}
plot.health <- data %>% 
  ggplot(aes(x = self_rated_health, y = feelings_life)) + 
  geom_boxplot() + 
  labs(title = "Graph 4 - Feelings of life vs. Self rated health ", x = "health", y = "feelings")

plot.mhealth <- data %>% 
  ggplot(aes(x = self_rated_mental_health, y = feelings_life)) + 
  geom_boxplot() + 
  labs(title = "Graph 5 - Feelings of life vs. Self rated mental health ", x = "mental health", y = "feelings")
...
Below is the summary table for relationship between feelings of life and marital status (Table 4) and total children (Table 5)
...
kable(table.m, caption = "Table 4: Feelings of life & marital status")
```
...
kable(table.t, caption = "Table 5: Feelings of life & total children")
```
...
The null hypothesis states that the $\beta_{n}$ is equal to zero, while the alternative hypothesis states that the $\beta_{n}$ is not equal to zero.\
...
1. The insignifiant features are: marital_statusSingle, never married, self_rated_healthFair, self_rated_mental_healthGood
...
kable(step$anova, caption = "Table 7 - BIC")
```
...
pvalue = c('< 2e-16', 3.08e-07, 6.84e-08, 0.020967, 2.68e-05, '< 2e-16', '< 2e-16', 5.32e-05, 0.026131, 0.061447, 3.30e-06, 0.957786, 0.455780, 2.83e-06, 0.441573, 0.008111, 0.002519, 0.000220, 2.83e-05, 1.87e-05, 0.928233, '< 2e-16', 0.024585, 0.064259, 0.050481, 0.080718, 0.834614, 0.091784, 0.000143, '< 2e-16', 0.020429, 0.124352, 0.694212)
kable(cbind(names, pvalue), caption = "Table 8 - p-values")
```
